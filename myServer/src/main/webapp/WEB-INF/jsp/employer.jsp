        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    <li><h3><a href="/myServer/update.jsp"> updateUser <i class="im-table2"></i></a></h3>
                    </li>
				</ul>
				 <ul id="sideNav" class="nav nav-pills nav-stacked">
                    <li><h3><a href="/myServer/delete.jsp"> deleteUser <i class="im-table2"></i></a></h3>
                    </li>
				</ul>
				<ul id="sideNav" class="nav nav-pills nav-stacked">
                    <li><h3><a href="/myServer/register.jsp"> registerUser <i class="im-table2"></i></a></h3>
                    </li>
				</ul>
