                        ...
                        <ul class="nav navbar-nav pull-right">
                            <li class="dropdown">
                                <a href="#" data-toggle="dropdown">
                                    <img class="user-avatar" src="/myServer/img/mainimg/48.jpg" alt="user">${user.userName}</a>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    <li><h3><a href="/myServer/updateCust.jsp"> updateCust <i class="im-table2"></i></a></h3>
                    </li>
				</ul>
				 <ul id="sideNav" class="nav nav-pills nav-stacked">
                    <li><h3><a href="/myServer/deleteCust.jsp"> deleteCust <i class="im-table2"></i></a></h3>
                    </li>
				</ul>
				<ul id="sideNav" class="nav nav-pills nav-stacked">
                    <li><h3><a href="/myServer/registerCust.jsp"> registerCust <i class="im-table2"></i></a></h3>
                    </li>
				</ul>
