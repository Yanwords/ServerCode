...
public class addfriend extends Activity {
   ...
   private final String url_constant = "/user/addFriend.do?";
    	  ...
    	  public void onClick(View v) {
    		  new Thread(new Runnable() {
                  ...
                  public void run() {
                	  ...
                	  url = HTTPUtil.url_constant + url_constant + "username="+MainActivity.USERNAME + "&friendname=" + friendname;
            		  Log.v("url", url);
...
//                                 Toast.makeText(MainActivity.this,key,Toast.LENGTH_LONG).show();
                              try {
                                  ...
                                  if ("success".equals(result)){
                                	  //Log.v()
                                      Toast.makeText(addfriend.this,"添加好友成功",Toast.LENGTH_LONG).show();
                                  }else {
                                      Toast.makeText(addfriend.this,"添加好友失败",Toast.LENGTH_LONG).show();
                                  }
