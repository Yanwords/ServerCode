...
public class login extends Activity {
   ...
   private final String url_constant = "/user/login.do?";
    		  ...
    		  */
    		  new Thread(new Runnable() {
                  ...
                  public void run() {
            		  ...
            		  String passWord= password.getText().toString();
            		  Log.v("passwd = ",passWord);
                	  url= HTTPUtil.url_constant + url_constant+"username="+userName+"&password="+passWord;
                	  Log.v("url", url);
...
//                                 Toast.makeText(MainActivity.this,key,Toast.LENGTH_LONG).show();
                              try {
                                  ...
                                  String result = (String) json.get("login");
