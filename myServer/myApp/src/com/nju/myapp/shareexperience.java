...
@SuppressLint("NewApi")
public class shareexperience extends Activity {
   private static String url = "";
   private final String url_constant = "/user/insertExperience.do?";
   private EditText  experienceContent=null;
   @SuppressLint("NewApi")
      ...
      experience.setOnClickListener(new View.OnClickListener() {
    	  ...
    	  public void onClick(View v) {
    		  new Thread(new Runnable() {
                  @Override
                  public void run() {
                	  String experInfo=experienceContent.getText().toString();
            		  Log.v("experienceInfo = ", experInfo);
            		  try {
  						experInfo = URLEncoder.encode(experInfo,"utf-8");
                	  ...
                	  url = HTTPUtil.url_constant + url_constant + "experinfo="+experInfo + "&experdate="+nowDate+"&username="+MainActivity.USERNAME;
            		  Log.v("url", url);
...
//	           	       	  String myUser = "";
	                      ...
	                      data.putString("experinfo", experInfo);
	                      msg.setData(data);
...
//                                 Toast.makeText(MainActivity.this,key,Toast.LENGTH_LONG).show();
                              try {
                                  ...
                                  String result = (String) json.get("experience");
                                  
                                  if ("success".equals(result)){
                                	  //Log.v()
                                      Toast.makeText(shareexperience.this,"增加分享成功",Toast.LENGTH_LONG).show();
                                  }else {
                                      Toast.makeText(shareexperience.this,"增加分享失败",Toast.LENGTH_LONG).show();
                                  }
