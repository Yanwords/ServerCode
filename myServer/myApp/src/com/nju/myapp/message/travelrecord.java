    	  ...
    	  public void onClick(View v) {
    		  new Thread(new Runnable() {
                  ...
                  public void run() {
                	  ...
                	  url = HTTPUtil.url_constant + url_constant + "travelinfo="+travelInfo + "&traveldate="+nowDate+"&username="+MainActivity.USERNAME;
            		  Log.v("url", url);
...
//}
   ...
   public void loginRemoteService(String userName,String password){
	   ...
	   try {
	       ...
	       //创建提示框提醒是否登录成功
	       AlertDialog.Builder builder=new Builder(scenicdisplay.this);
	       builder.setTitle("提示")
	       .setMessage(myUser)
