...
@SuppressLint("NewApi")
public class travelrecord extends Activity {
	private static String url = "";
	private final String url_constant = "/user/insertTravel.do?";
	private EditText travelContent = null;
	@SuppressLint("NewApi")
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.travelrecord);
		travelContent = (EditText) findViewById(R.id.editText1);
		...
		travel.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				new Thread(new Runnable() {
					@Override
					public void run() {
						String travelInfo = travelContent.getText().toString();
						Log.v("travelInfo = ", travelInfo);
						try {
							travelInfo = URLEncoder.encode(travelInfo, "utf-8");
						...
						url = HTTPUtil.url_constant + url_constant + "travelinfo=" + travelInfo + "&traveldate="
								+ nowDate + "&username=" + MainActivity.USERNAME;
						Log.v("url", url);
...
//	           	       	  String myUser = "";
							...
							data.putString("travelinfo", travelInfo);
							msg.setData(data);
...
//                                 Toast.makeText(MainActivity.this,key,Toast.LENGTH_LONG).show();
								try {
									...
									String result = (String) json.get("travel");

									if ("success".equals(result)) {
										// Log.v()
										Toast.makeText(travelrecord.this, "增加出游记录成功", Toast.LENGTH_LONG).show();
									} else {
										Toast.makeText(travelrecord.this, "增加出游记录失败", Toast.LENGTH_LONG).show();
									}
	...
	private void initView() {
		findViewById(R.id.sign_iv).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				startActivity(new Intent(travelrecord.this, MainActivity.class));
			}
		});
	}
}
