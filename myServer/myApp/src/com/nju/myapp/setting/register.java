...
public class register extends Activity {
   ...
   private final String url_constant = "/user/register.do?";
            		  ...
            		  try {
						...
						// TODO Auto-generated catch block
            			  e1.printStackTrace();
           	       	  ...
           	       	  url= HTTPUtil.url_constant + url_constant+"username="+userName+"&password="+passWord+"&gender="+userGender+"&age="+userAge;
           	          Log.d("远程URL", url);
...
//                                 Toast.makeText(MainActivity.this,key,Toast.LENGTH_LONG).show();
    ...
    */
   /*
   public void registerRemoteService(String userName,String password, String gender, String age){
	   String result=null;
	   try {
	       //创建一个HttpClient对象
	       @SuppressWarnings("resource")
		HttpClient httpclient = new DefaultHttpClient();
	       ...
	       url= url_constant+"username="+userName+"&password="+password+"&gender="+gender+"&age="+age;
	       Log.d("远程URL", url);
	       //创建HttpGet对象
//	       HttpGet request=new HttpGet(url);
	       ...
	       if(json!=null){
	    	   ...
	    	   result=jsonObject.get("register").toString();
	       }
	       if(result==null){
	    	   json="登录失败请重新登录";
	       }
